    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        <h6 style="text-align: center;">Isi Kolom di Bawah Ini Untuk Melakukan Registrasi</h7>
                    </div>
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input type="date" class="form-control datepicker" name='tgl_lahir' placeholder="">
                            </div>
                        </div>

                        <div class="row mb-3">
                            <label for="telp" class="col-md-4 col-form-label text-md-end">{{ __('No Telephone') }}</label>
